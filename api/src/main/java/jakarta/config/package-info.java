 ...
 * <li>all {@code META-INF/jakartaconfig.properties} files on the ClassPath.
 *  (ordinal=100, separately configurable via a config_ordinal property inside each file)</li>
 * </ul>
 *
 * <p>That means that one can put the default configuration in a {@code META-INF/jakartaconfig.properties} anywhere on the classpath.
