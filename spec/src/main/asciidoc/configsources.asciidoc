...
among environment variables, the variable name needs to be the same with case sensitive (e.g. com_ACME_size). If not found, try to match the case-insensitive environment variable (e.g. COM_ACME_SIZE or COM_ACME_Size).
