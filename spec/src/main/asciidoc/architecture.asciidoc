...
The Configuration for Java API specification (or short: JavaConfig) provides a way to achieve this goal by aggregating configuration from many different <<configsource,ConfigSources>> and presents a single merged view to the user.
